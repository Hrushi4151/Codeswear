    ...
    return (
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 min-h-screen">
            <div className="mx-auto max-w-lg">
                ...
                {!isEmailSent &&  <form method='POST' className="mb-0 mt-6 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                    <p className="text-center text-lg font-medium ">Forgot Password</p>

                    <input autoComplete="off" onChange={handleEmailChange} type="email" required={true} className=" w-full rounded-lg border-gray-200 p-4  text-sm shadow-sm" placeholder="Enter your Email" />
